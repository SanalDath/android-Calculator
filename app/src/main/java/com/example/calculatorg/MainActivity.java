...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn00.setOnClickListener(numberListener);
        ...
        // Clear last character button listener
        ...
        btnRoot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!input.equals("")) {
                    ...
                    Double result = Math.sqrt(valueOne);
                    textResult.setText(result.toString());
                    input = "";
                }
            }
    ...
    private void handleOperator(String operatorSymbol) {
        if (!input.equals("")) {
            ...
            textResult.setText(input + " " + operator);  // Display the operator
            input = "";
        }
    }
